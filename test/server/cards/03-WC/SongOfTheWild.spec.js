describe('Song Of The Wild', function () {
    describe("Song Of The Wild's ability", function () {
        beforeEach(function () {
            this.setupTest({
                player1: {
                    ...
                    hand: ['song-of-the-wild', 'dark-faerie']
                },
                player2: {
        ...
        //From archon arcana: "Song of the Wild creates a lasting effect for the remainder of the turn that applies to all cards in play during the specified period, regardless of whether they were in play at the time the lasting effect was established."
        xit("should give newly played friendly creatures 'Reap: Gain 1A' until the end of the turn", function () {
            this.player1.play(this.songOfTheWild);
            this.player1.reap(this.dustPixie);
            this.player1.reap(this.rustgnawer);
            this.player1.reap(this.snufflegator);
            expect(this.player1.amber).toBe(6);
            this.player1.play(this.darkFaerie);
